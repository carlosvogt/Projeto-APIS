...
function DropdownComponent({
  ...
  const styles = StyleSheet.create({
    container: {
      ...
      borderTopRightRadius: isFocus && mode === 'top' ? 0 : 10,
      borderTopLeftRadius: isFocus && mode === 'top' ? 0 : 10,
      borderBottomLeftRadius: isFocus && mode === 'bottom' ? 0 : 10,
      borderBottomRightRadius: isFocus && mode === 'bottom' ? 0 : 10,
      marginVertical: 8,
    ...
    containerStyle: {
      borderBottomLeftRadius: mode === 'top' ? 0 : 10,
      borderBottomRightRadius: mode === 'top' ? 0 : 10,
      borderTopRightRadius: mode === 'bottom' ? 0 : 10,
      borderTopLeftRadius: mode === 'bottom' ? 0 : 10,
